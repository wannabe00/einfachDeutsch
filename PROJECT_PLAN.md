...
- [ ] **15.2 Streaks + freeze tokens** — `StreakRecord` (current/longest streak, freeze_tokens_available, last_active_date); auto-consume a freeze on a missed scheduled day instead of resetting; defaults above, all **configurable settings**.
